...
export async function generateMetadata(
	...
	return createPageMetadata('METADATA.SETTINGS', locale, parent, { path: `/${workspace}/settings` })
}

export default async function SettingsPage({ params }: WorkspacePageProps) {
	...
	const breadcrumbs: DashboardBreadcrumb[] = [
		{
			...
			icon: 'Settings',
			title: t('TITLE'),
			'data-testid': 'breadcrumb-settings'
		}
	]
